...
#define PIN_MODE  PIN_BCM
//#define PIN_MODE  PIN_WPI_NUM

#define SONAR_FRONT_ECHO  		14 //BCM
#define SONAR_FRONT_TRIGGER  	15 //BCM
#define SONAR_LEFT_ECHO  		05 //BCM
#define SONAR_LEFT_TRIGGER  	06 //BCM
